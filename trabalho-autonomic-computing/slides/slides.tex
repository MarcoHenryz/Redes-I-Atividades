...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{columns}
      \column{0.55\textwidth}
      \begin{itemize}\small
        \item \textbf{63\%} do TCO da infraestrutura física de data center = energia + resfriamento + eletricidade (Huebscher \& McCann, 2008)
  ...
  \begin{frame}
    ...
    \begin{block}{Resposta}
      ...
      \begin{itemize}
        ...
        \item Auto-cura: falha de nó $\rightarrow$ migração automática de VMs, transparente ao usuário final
      \end{itemize}
      \textbf{IoT:}
      \begin{itemize}
