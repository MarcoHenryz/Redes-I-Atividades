...
\begin{document}
  ...
  \begin{frame}
    ...
    \end{itemize}
    \vspace{0.2cm}
    \begin{block}{Elemento Gerenciado pode ser qualquer coisa}
      Servidor web, BD, SO, cluster de máquinas, rede com ou sem fio, CPU --- qualquer recurso ao qual se deseja conferir comportamento autônomo
    \end{block}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item O survey propõe 4 \textbf{elementos de autonomicidade} como alternativa aos 5 níveis IBM:
      \begin{itemize}
